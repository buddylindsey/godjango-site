...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.meta_keywords'
        db.add_column(u'episode_video', 'meta_keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.meta_keywords'
        db.delete_column(u'episode_video', 'meta_keywords')
    ...
    models = {
        ...
        u'episode.favorite': {
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['episode.Video']"})
        },
        u'episode.video': {
            ...
            'favorites': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['episode.Favorite']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
