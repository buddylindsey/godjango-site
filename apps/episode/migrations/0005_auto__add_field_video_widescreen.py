...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.widescreen'
        db.add_column(u'episode_video', 'widescreen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.widescreen'
        db.delete_column(u'episode_video', 'widescreen')
    ...
    models = {
        ...
        u'episode.video': {
            ...
            'widescreen': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
