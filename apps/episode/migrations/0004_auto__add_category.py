...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'episode_category', (
        ...
        db.send_create_signal(u'episode', ['Category'])

        # Adding M2M table for field videos on 'Category'
        db.create_table(u'episode_category_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'episode.category'], null=False)),
            ('video', models.ForeignKey(orm[u'episode.video'], null=False))
        ))
        db.create_unique(u'episode_category_videos', ['category_id', 'video_id'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'episode_category')

        # Removing M2M table for field videos on 'Category'
        db.delete_table('episode_category_videos')
    ...
    models = {
        ...
        u'episode.category': {
            ...
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'categories'", 'symmetrical': 'False', 'to': u"orm['episode.Video']"})
        },
        u'episode.video': {
            ...
            'preview_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'thumbnail_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
